...
public abstract class PopupPane extends StackPane {
    ...
    /** The display name shown as the tooltip title. */
    private final String displayName;

    /** The display description shown as the tooltip body. */
     ...
     *
     * <p>Upon entering, the pane scales to 110% and is brought to the front
    ...
    private void setupTooltip() {
        ...
        tooltip.setOnShowing(e -> tooltip.setAnchorY(tooltip.getAnchorY() + 10));
    ...
    /**
     * Builds a {@link VBox} with a white background and drop shadow.
     * @return the constructed {@link VBox}
     */
