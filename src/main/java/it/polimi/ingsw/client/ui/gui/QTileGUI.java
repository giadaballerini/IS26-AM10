...
public class QTileGUI extends PopupPane {
    ...
    public QTileGUI(int qTileId) {
        ...
        this.addEventHandler(MouseEvent.MOUSE_ENTERED, e -> this.anchorPane.setOpacity(0.4));
        this.addEventHandler(MouseEvent.MOUSE_EXITED, e -> this.anchorPane.setOpacity(1));
    }
     ...
     * are released in insertion order (the lowest index first).</p>
     *
