...
public class CommandParser {
     ...
     *   <li>{@code quit} — exits the current match</li>
     *   <li>{@code exit} — disconnects and terminates the application</li>
     ...
     *   <li>{@code pgup} — scrolls the players panel up by one player block</li>
     *   <li>{@code pgdn} — scrolls the players panel down by one player block</li>
     * </ul>
     *
    ...
    public static Command parse(String input, Client client) throws InvalidLobbySizeException, InvalidTimingException {
        ...
        try {
            return switch (action) {
                ...
                case "pgup"    -> new ScrollPlayersCommand(-4);
                case "pgdn"    -> new ScrollPlayersCommand(4);
                default        -> null;
            };
