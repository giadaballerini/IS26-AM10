...
public class EndGameScreen {
    ...
    /** JLine terminal handle used to query screen dimensions and write the end-game summary. */
    ...
    public void renderScreen() {
        ...
        String fullGlobalLine = getString();
        ...
        for (int i = 0; i < stats.size(); i++) {
            ...
            String line = String.format("%-6s %-20s %8d %8d",
    ...
    /**
     * Returns the string to display for the global ranking position.
     *
     * @return the global ranking position string
     */
    private String getString() {
        ...
        return globalLine + globalSuffix;
    }
