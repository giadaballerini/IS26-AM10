/**
 * Defines the module configuration for the Mesos application.
 * Formatted and grouped by architectural concerns (Dependencies, Public APIs, RMI, Jackson, JavaFX).
 */
module it.polimi.ingsw {
    ...
    opens it.polimi.ingsw.server to com.fasterxml.jackson.databind, java.rmi;
    opens it.polimi.ingsw.client to com.fasterxml.jackson.databind, java.rmi;
    ...
    opens it.polimi.ingsw.network.dto to com.fasterxml.jackson.databind, java.rmi;
    opens it.polimi.ingsw.network.server to com.fasterxml.jackson.databind, java.rmi;
