...
class ShamanTest {
    ...
    Shaman shaman = new Shaman(1, GamePhaseEnum.DRAW_PHASE, new ArrayList<>(), new ArrayList<>(), 2, CardTypeEnum.SHAMAN);
    ...
    void testShouldAcceptVillageVisitor() {
        shaman.accept(visitorVillage);

        verify(visitorVillage).visit(shaman);
    }
}