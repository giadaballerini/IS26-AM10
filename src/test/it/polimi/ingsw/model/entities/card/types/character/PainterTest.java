...
class PainterTest {
    ...
    Painter painter = new Painter(1, GamePhaseEnum.DRAW_PHASE, new ArrayList<>(), new ArrayList<>(), 2, CardTypeEnum.BUILDER);
    ...
    void testShouldAccept() {
        ...
        painter.accept(visitorGFood, mockPlayer, GainFoodMock);
        painter.accept(visitorPP, mockPlayer, GainPPMock);

        verify(visitorGFood).visit(painter, mockPlayer, GainFoodMock);
        verify(visitorPP).visit(painter, mockPlayer, GainPPMock);
    }
}